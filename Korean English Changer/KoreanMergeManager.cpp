...
std::unordered_map<std::wstring, wchar_t> KoreanMergeManager::last = { {L"r", 1}, {L"R", 2}, {L"rt", 3}, {L"s", 4}, {L"S", 4}, {L"sw", 5}, {L"Sw", 5}, {L"sg", 6}, {L"sG", 6}, {L"Sg", 6}, {L"SG", 6}, {L"e", 7}, {L"f", 8}, {L"F", 8}, {L"fr", 9}, {L"Fr", 9}, {L"fa", 10}, {L"fA", 10}, {L"Fa", 10}, {L"FA", 10}, {L"fq", 11}, {L"Fq", 11}, {L"ft", 12}, {L"Ft", 12}, {L"fx", 13}, {L"fX", 13}, {L"Fx", 13}, {L"FX", 13}, {L"fv", 14}, {L"fV", 14}, {L"Fv", 14}, {L"FV", 14}, {L"fg", 15}, {L"fG", 15}, {L"Fg", 15}, {L"FG", 15}, {L"a", 16}, {L"A", 16}, {L"q", 17}, {L"qt", 18}, {L"t", 19}, {L"T", 20}, {L"d", 21}, {L"D", 21}, {L"w", 22}, {L"W", 22}, {L"c", 23}, {L"C", 23}, {L"z", 24}, {L"Z", 24}, {L"x", 25}, {L"X", 25}, {L"v", 26}, {L"V", 26}, {L"g", 27}, {L"G", 27} };
